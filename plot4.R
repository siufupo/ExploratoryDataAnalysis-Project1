...
legend("topright",legend=names(data2)[c(7,8,9)],col=c("black","red","blue"),lty=1,lwd=1,bty="n")
plot(data2$DateTime,data2$Global_reactive_power,type="l",xlab="datetime",ylab=names(data2)[4])
dev.off()
